public class Seq_Arranjo {
    public static class SeqArray implements Seq_Interface {
        private int size;
        ...
        @Override
        public Object before(int p) throws ESeqIndice, ElementoInexistente, ESeqVazia{
            if (p < 0 || p >= this.size){
        ...
        @Override
        public Object after(int p) throws ESeqIndice, ElementoInexistente, ESeqVazia{
            if (p < 0 || p >= this.size){
                throw new ESeqIndice("Índice inválido");
            }
            if (isEmpty()){
